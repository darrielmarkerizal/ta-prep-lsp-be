        ...
        _ctx.example ? (openBlock(), createElementBlock("div", _hoisted_1, [
          ...
          createElementVNode("div", _hoisted_2, [
            createElementVNode("button", {
              ...
              type: "button",
              onClick: _cache[0] || (_cache[0] = ($event) => unref(copyToClipboard)(String(unref(formatExample)(_ctx.example))))
            }, [
          ...
          createElementVNode("div", _hoisted_5, [
            (openBlock(true), createElementBlock(Fragment, null, renderList(_ctx.examples, (ex, key) => {
              return openBlock(), createElementBlock("button", {
                ...
                class: "property-example-value group",
                type: "button",
                onClick: ($event) => unref(copyToClipboard)(String(unref(formatExample)(ex)))
              }, [
