...
import { createWorkspaceEventBus, onCustomEvent } from "@scalar/workspace-store/events";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose }) {
    ...
    const sidebarItems = computed(() => {
      ...
      if (config.expandAllModelSections) {
        const models = docItems.find(
          (item) => item.type === "tag" && item.id === "models"
        );
        if (models) {
    ...
    eventBus.on(
      "toggle:nav-item",
      ({ id, open }) => sidebarState.setExpanded(id, open ?? !sidebarState.isExpanded(id))
    );
        ...
        createElementVNode("div", {
          ...
          createElementVNode("main", {
            ...
            createVNode(_sfc_main$4, {
              ...
              getSecuritySchemes: unref(getSecuritySchemes),
              ...
              options: {
                ...
                hiddenClients: mergedConfig.value.hiddenClients,
                ...
                mergedConfig.value.layout === "classic" ? (openBlock(), createBlock(ClassicHeader, { key: 1 }, {
                  ...
                  default: withCtx(() => [
                    ...
                    !mergedConfig.value.hideSearch ? (openBlock(), createBlock(_sfc_main$3, {
                      ...
                      items: sidebarItems.value,
                      searchHotKey: mergedConfig.value.searchHotKey
                    }, null, 8, ["eventBus", "hideModels", "items", "searchHotKey"])) : createCommentVNode("", true)
                  ]),
                  _: 1
                })) : createCommentVNode("", true),
            ...
            ]), 1032, ["activeServer", "document", "eventBus", "expandedItems", "getSecuritySchemes", "infoSectionId", "items", "options", "xScalarDefaultClient"])
          ], 8, _hoisted_3),
