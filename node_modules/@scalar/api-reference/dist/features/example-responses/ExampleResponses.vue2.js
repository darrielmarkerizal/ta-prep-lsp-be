...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const currentResponse = computed(() => {
      const currentStatusCode = toValue(orderedStatusCodes)[toValue(selectedResponseIndex)] ?? "";
    ...
    return (_ctx, _cache) => {
      return orderedStatusCodes.value.length ? (openBlock(), createBlock(unref(ScalarCard), {
        key: 0,
